...
```
It's not mandatory but I changed the name of these classes to `DepartmentApplication` and `EmployeeApplication` 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjM0NjU5MTY2LDEyMDE2MDIxNDIsLTEzMz
