...
Furthermore we have to add a `Source Folder`  namesd `resources` to both projects under  `src/main`.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwNTQ2OTk0MjEsLTE0MTcyMjMxNzYsMT
IwMTYwMjE0MiwtMTMzMzkyNTE0NiwyMTM5NzgxMDRdfQ==
-->